...
Heidi has been running daily since early 2026.
...
- Weekly outfit planning for the kids based on 7-day weather forecast and calendar (picture days, outdoor events, soccer)
...
├── SOUL.md            # Identity, values, operating principles (stub — household details private)
...
├── CHILD_SAFETY.md    # Hard rules for handling data involving minor children (stub — details private)
├── crm/
│   ├── relationships.md   # Relationship/contact data (stub — private in production)
│   └── cards-and-gifts.md # Card and gift planning (stub — private in production)
└── eggs/
...
- `crm/relationships.md` — real names, contact info, relationship data. Stub only.
- `crm/cards-and-gifts.md` — card and gift planning with real names. Stub only.
...
- `returns/returns_log.md` — live returns log with purchase details. Stub only.
...
Heidi is in active daily use. Current working integrations: Gmail, Google Calendar, Google Docs, Google Sheets, Apple Reminders.
